<template>
    <div class="mb">
        ...
        <div class="tabItem">
            <a  href="javascript:;" v-for="(item) in photoNav" @click="getImages(item.tip)" v-text="item.title" :class="item.id==1?'active':''" :key="item.id"></a>
        </div>
        <div class="tabCon">
    ...
    export default {
        ...
        methods:{
            ...
            tabBtn(){
                ...
                let conList = document.getElementsByClassName('conList');
